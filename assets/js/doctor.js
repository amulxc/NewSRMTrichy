...
function createDoctorCard(doctor) {
    ...
    let imgPath = `./assets/images/doctors/${doctor["Contact Number"] == "9894489142" || doctor["Contact Number"] == "7708490384" ? doctor["Contact Number"] + ".jpg" : doctor["Contact Number"] + ".JPG"}`;
