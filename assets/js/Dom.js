  ...
  const quickAccess = `<div class="quick-access" id="desktop-quickaccess">
   ...
   <div class="milestone-stats1">
    ...
    <div class="nav-wrapper">
      <a href='index.html'>
        <div class="logo">
          <img src="assets/images/logo1.png" alt="SRM">
        </div>
      </a>
            ...
            <ul class="dropdown">
              ...
              <li class="has-submenu" data-submenu="milestones">
                ...
                <ul class="sub-dropdown">
                  <li><a href="about.html#logos">NAAC</a></li>
                  <li><a href="about.html#logos">NABH</a></li>
                  <li><a href="about.html#logos">NABL</a></li>
                  <li><a href="about.html#logos">PM JAY</a></li>
                </ul>
              </li>
    ...
    const footer = `<div class="footer-container">
            <div class="footer-about">
                 <div class="logo footer-logo">
                    <img src="assets/images/logo1.png" alt="SRM Logo">
                </div>
...
const pages = [
      ...
      { title: 'Academic Departments', path: 'Academics > Departments', url: './academic_department.html' },
      { title: 'Academic Media & Outreach', path: 'Academics > Media', url: './media.html' },
      { title: 'Academic News & Events', path: 'Academics > News & Events', url: './media.html#news' },
      { title: 'Academic Gallery', path: 'Academics > Gallery', url: './media.html#gallery' },
